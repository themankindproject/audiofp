...
| 2.8 | **Bounded-memory streaming buffer trim** | P2 | S | `accumulated` in `StreamingX` could grow unbounded for very long sessions. Trim once finalised hashes have been emitted. |
